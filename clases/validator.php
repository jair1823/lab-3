    ...
    class Validator
    {
        ...
        public function validateName($name)
        {
            if (empty($name)) {
                ...
                if (!preg_match("/^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]*$/", $this->data["name"]) || (strlen($this->data["name"]))>30) {
                    $this->errores["name"] =  "Este nombre no es valido.\nNo puede tener ni espacios ni numeros.";
                }
            }
        }
        ...
        public function validateLastname1($lastname1)
        {
            if (empty($lastname1)) {
                ...
                if (!preg_match("/^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]*$/", $this->data["lastname1"]) || (strlen($this->data["lastname1"]))>30) {
        ...
        public function validateLastname2($lastname2)
        {
            if (empty($lastname2)) {
                ...
                if (!preg_match("/^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]*$/", $this->data["lastname2"]) || (strlen($this->data["lastname2"]))>30) {
